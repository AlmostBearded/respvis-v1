...
//   LegendPosition,
// } from '../legend';
// import { barFind } from './series-bar';
// import {
...
// import { SeriesLabelBar, seriesLabelBarDataHydrate, seriesLabelBar } from './series-label-bar';
...
//   return {
//     ...seriesData,
//     ...chartCartesianDataHydrate(data),
//     legend: data.legend || {},
...
//     const labelSeriesD = seriesLabelBarDataHydrate({
...
//     barFind(chart, category).classed('highlight', hover);
//     labelFindByFilter(
//       chart.selectAll('.series-label-bar'),
